...
namespace MaterialRemove.Geometry.Mesh
{
    ...
    public partial class DMesh3 : IDeformableMesh
    {
        ...
        private void debug_check_is_vertex(int vID) {
            Debug.Assert(vID >= 0 && vID < vertices_refcount.count, "DMesh3.GetVertex: invalid vertex ID");
            Debug.Assert(vertices_refcount.isValid(vID), "DMesh3.GetVertex: vertex ID is not valid");
        }
        ...
        private void debug_check_is_triangle(int tID) {
            Debug.Assert(tID >= 0 && tID < triangles_refcount.count, "DMesh3.GetTriangle: invalid triangle ID");
            Debug.Assert(triangles_refcount.isValid(tID), "DMesh3.GetTriangle: triangle ID is not valid");
        }
        ...
        private void debug_check_is_edge(int eID) {
            Debug.Assert(eID >= 0 && eID < edges_refcount.count, "DMesh3.GetEdge: invalid edge ID");
            Debug.Assert(edges_refcount.isValid(eID), "DMesh3.GetEdge: edge ID is not valid");
        }
